...
NAN_MODULE_INIT(Finder::Init)
{
    ...
    Nan::SetPrototypeMethod(tpl, "GetWorkpieceShape", GetWorkpieceShape);
...
NAN_METHOD(Finder::GetWorkpieceShape)
{
    Finder * find = Nan::ObjectWrap::Unwrap<Finder>(info.This());
    ...
    double height = 0;
    int flag = 0;
    if (!find->_find->is_shape_workpiece(wp_id.FromJust(), flag, x, y, z, length, width, height)) return;
    v8::Local<v8::Object> rtn = Nan::New<v8::Object>();
    Nan::Set(rtn, CharTov8String("x"), Nan::New(x));
    Nan::Set(rtn, CharTov8String("y"), Nan::New(y));
    Nan::Set(rtn, CharTov8String("z"), Nan::New(z));
